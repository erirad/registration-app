...
$sql3 = "INSERT INTO `clients` (`id`, `name`, `created_at`, `updated_at`, `served`, `duration`, `login_key`, `consultant_id`) VALUES
...
$sql4 = "CREATE TABLE `consultants` (
  `id` int(11) NOT NULL,
  `name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1";

$sql5 = "INSERT INTO `consultants` (`id`, `name`) VALUES
(1, 'James'),
(2, 'Robert'),
(3, 'Michael'),
(4, 'Christopher')";

$sql6 = "ALTER TABLE `clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `client_consultant` (`consultant_id`)";

$sql7 = "ALTER TABLE `consultants`
    ADD PRIMARY KEY (`id`)";

$sql8 = "ALTER TABLE `clients`
      MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18";

$sql9 = "ALTER TABLE `consultants`
        MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5";

$sql10 = "ALTER TABLE `clients`
          ADD CONSTRAINT `client_consultant` FOREIGN KEY (`consultant_id`) REFERENCES `consultants` (`id`);
        COMMIT";

$sql11 = "SET SQL_MODE = 'NO_AUTO_VALUE_ON_ZERO'";
$sql12 = "SET AUTOCOMMIT = 0";
$sql13 = "START TRANSACTION";
$sql14 = "SET time_zone = '+00:00'";
$sql0 = "show tables like 'clients'";

$sqls = [$sql11, $sql12, $sql13, $sql14, $sql2, $sql3, $sql4, $sql5, $sql6, $sql7, $sql8, $sql9, $sql10];
